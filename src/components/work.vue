				...
				<div class="work-holder row">
					<div class="col-md-2 work-tab">
						<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							...
							<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Kelechek Digital</a>
						</div>
					</div>
					<div class="col-md-10">
						<div class="tab-content pl-2" id="v-pills-tabContent">
							<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab"><h6 style="color: var(--white)">Frontend Developer  <span style="color: var(--green)">@ECX</span> </h6><p>August 2021 - May 2022</p>
							...
							<div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"><h6 style="color: var(--white)">Frontend Developer  <span style="color: var(--green)">@Kelechek Digital</span> </h6><p>September 2018 - NOW</p>
								<ul class="fa-ul pl-0 ml-3">
